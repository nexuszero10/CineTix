<x-guest-layout>
    <div
        class="bg-[#0d1b2a] text-white rounded-xl shadow-2xl p-8 md:p-10 w-full max-w-md animate-[slideIn_0.8s_ease-out]">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="relative mb-5">
                ...
                <i class="absolute left-3 top-3.5 text-gray-400">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="currentColor" viewBox="0 0 16 16">
                        <path
                            d="M3 2a1 1 0 0 0-1 1v2.586a1 1 0 0 0 .293.707l6.414 6.414a1 1 0 0 0 1.414 0l2.586-2.586a1 1 0 0 0 0-1.414L6.414 2.293A1 1 0 0 0 5.707 2H3zm1 1h1.586l6.414 6.414-1.586 1.586L4 4.414V3z" />
                        <path d="M1 14a1 1 0 1 0 2 0 1 1 0 0 0-2 0z" />
                    </svg>
                </i>
