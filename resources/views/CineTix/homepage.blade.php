...
<head>
  ...
  <link rel="stylesheet" href="animation/home_animasi.css">
  <link rel="stylesheet" href="responsive/home._responsive.css">
</head>
<body>
...
<main>
    <h1 class="cinetix-heading">Feel the meanings beyond</h1>

    <div class="cinetix-search-bar">
      <i class="fas fa-search cinetix-search-icon"></i>
      <input class="cinetix-search-input" placeholder="Cari film atau bioskop">
  ...
  <div class="container py-4">
    ...
    <div id="movieCarousel" class="carousel slide carousel-cinematic mb-5" data-bs-ride="carousel">
      ...
      <button class="carousel-control-prev carousel-cinematic-prev" type="button" data-bs-target="#movieCarousel" data-bs-slide="prev">
        <span class="carousel-control-prev-icon"></span>
      </button>
      <button class="carousel-control-next carousel-cinematic-next" type="button" data-bs-target="#movieCarousel" data-bs-slide="next">
  ...
  <div class="movie-card">
    ...
    <div class="movie-info">
      <div>
        ...
        <p class="text-light">Agen FBI yang menemukan konspirasi besar setelah menerima panggilan misterius...</p>
      </div>
  ...
  <div class="movie-card">
    ...
    <div class="movie-info">
      <div>
        ...
        <p class="text-light">Sekelompok pemuda menghadapi misteri yang mengancam persahabatan mereka...</p>
      </div>
      <div class="d-flex justify-content-between mt-3">
        <a href="#" class="btn btn-custom btn-sm">Beli Tiket</a>
        <a href="#" class="btn btn-detail btn-sm">Detail</a>
  ...
  <div class="movie-card">
    ...
    <div class="movie-info">
      <div>
        ...
        <p class="text-light">Kisah cinta remaja antara Dilan dan Milea yang penuh romantisme khas tahun 90an...</p>
      </div>
      <div class="d-flex justify-content-between mt-3">
        <a href="#" class="btn btn-custom btn-sm">Beli Tiket</a>
        <a href="#" class="btn btn-detail btn-sm">Detail</a>
  ...
  <div class="movie-card">
    ...
    <div class="movie-info">
      <div>
        ...
        <p class="text-light">Kasih Sayang sepanjang masa, semua yang baik akan mendapat kebaikan nya masing masing ... </p>
      </div>
      <div class="d-flex justify-content-between mt-3">
        <a href="#" class="btn btn-custom btn-sm">Beli Tiket</a>
        <a href="#" class="btn btn-detail btn-sm">Detail</a>
    ...
    <div class="container mt-5">
      ...
      <div class="film-scroll-wrapper">
        <div class="film-item card bg-dark text-white border-0">
          <img src="https://i.ibb.co.com/tMP2Kk02/avatar.jpg" class="card-img-top rounded" alt="Avatar" style="height: 280px; object-fit: cover;">
          <div class="card-body text-center">
            <p class="card-title fw-semibold mb-0">AVATAR</p>
          </div>
        </div>
    
        <div class="film-item card bg-dark text-white border-0">
          <img src="https://i.ibb.co.com/cc6LBR0W/blade.jpg" class="card-img-top rounded" alt="Blade Runner" style="height: 280px; object-fit: cover;">
          <div class="card-body text-center">
            <p class="card-title fw-semibold mb-0">BLADE RUNNER 2049</p>
          </div>
        </div>
    
        <div class="film-item card bg-dark text-white border-0">
          <img src="https://i.ibb.co.com/3ysTdpVt/spiderman.png" class="card-img-top rounded" alt="Spider-Man" style="height: 280px; object-fit: cover;">
          <div class="card-body text-center">
            <p class="card-title fw-semibold mb-0">SPIDER-MAN NO WAY HOME</p>
          </div>
        </div>
    
        <div class="film-item card bg-dark text-white border-0">
          <img src="https://i.ibb.co.com/rgWSV8K/avenger.jpg" class="card-img-top rounded" alt="Avengers" style="height: 280px; object-fit: cover;">
          <div class="card-body text-center">
            <p class="card-title fw-semibold mb-0">AVENGERS INFINITY WAR</p>
          </div>
        </div>
    
        <div class="film-item card bg-dark text-white border-0">
          <img src="https://i.ibb.co.com/Kxx1ZrWG/guardians.webp" class="card-img-top rounded" alt="Guardians" style="height: 280px; object-fit: cover;">
          <div class="card-body text-center">
            <p class="card-title fw-semibold mb-0">GUARDIANS OF THE GALAXY</p>
          </div>
        </div>
      </div> <!-- .film-scroll-wrapper -->
    </div> <!-- .container -->
  ...
  <div class="container">
    ...
    <div class="row g-4">
      <div class="col-12 col-sm-6 col-md-4 text-center">
        <div class="film-card">
          <img src="https://i.ibb.co.com/Qjrdt3KC/yowis1.jpg" class="img-fluid rounded shadow-sm poster-img" alt="Yowis Ben 1">
          <p class="film-title">YOWIS BEN 1 : THE SERIES</p>
        </div>
      </div>
      <div class="col-12 col-sm-6 col-md-4 text-center">
        <div class="film-card">
          <img src="https://i.ibb.co.com/hJHpYwJk/yowis2.jpg" class="img-fluid rounded shadow-sm poster-img" alt="Yowis Ben 2">
          <p class="film-title">YOWIS BEN 2 : THE SERIES</p>
        </div>
      </div>
      <div class="col-12 col-sm-6 col-md-4 text-center">
        <div class="film-card">
          <img src="https://i.ibb.co.com/bjvTBmtC/yowis3.jpg" class="img-fluid rounded shadow-sm poster-img" alt="Yowis Ben 3">
    ...
    <div class="col-lg-8">
      ...
      <div class="card mb-4 bg-transparent border-0 berita-item" data-aos="fade-up">
        <div class="row g-0 align-items-stretch">
          <div class="col-md-5">
            <img src="https://i.ibb.co.com/xqvdvzgL/bom.jpg" class="img-fluid rounded-start" alt="berita 1">
          </div>
          <div class="col-md-7">
            <div class="card-body">
              <h5 class="card-title fw-bold">Pertaruhan: Kisah Kelam Persaudaraan yang Berjuang Demi Hidup Bapaknya</h5>
              <small class="text-muted">Selasa, 25 Mei 2025</small>
              <p class="card-text mt-2">Menceritakan perjuangan empat bersaudara laki-laki yang berjuang untuk menyelamatkan ayah mereka...</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <!-- BERITA 2 -->
      <div class="card mb-4 bg-transparent border-0 berita-item" data-aos="fade-up" data-aos-delay="100">
        <div class="row g-0 align-items-stretch">
          <div class="col-md-5">
            <img src="https://i.ibb.co.com/4wfRzkM2/jumbo-berita.png" class="img-fluid rounded-start" alt="berita 2">
          </div>
          <div class="col-md-7">
            <div class="card-body">
              <h5 class="card-title fw-bold">Jumbo: Film Petualangan Terlaris ke-4 Sepanjang Masa 2025</h5>
              <small class="text-muted">Selasa, 25 Mei 2025</small>
              <p class="card-text mt-2">Don, seorang anak yatim piatu yang sering diolok karena badannya yang besar...</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <!-- BERITA 3 -->
      <div class="card mb-4 bg-transparent border-0 berita-item" data-aos="fade-up" data-aos-delay="200">
        <div class="row g-0 align-items-stretch">
          <div class="col-md-5">
            <img src="https://i.ibb.co.com/sdrWrM4r/b1g1.png" class="img-fluid rounded-start" alt="berita 3">
          </div>
          <div class="col-md-7">
            <div class="card-body">
              <h5 class="card-title fw-bold">BUY 1 GET 1 FREE: Gunakan Kode Voucher “GLITBRUX”</h5>
              <small class="text-muted">Selasa, 25 Mei 2025</small>
              <p class="card-text mt-2">Masukkan kode voucher saat pembelian untuk menikmati penawaran menarik ini...</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <!-- BERITA 4 -->
      <div class="card mb-4 bg-transparent border-0 berita-item" data-aos="fade-up" data-aos-delay="300">
        <div class="row g-0 align-items-stretch">
          <div class="col-md-5">
            <img src="https://i.ibb.co.com/pj17fxt0/mandiri.png" class="img-fluid rounded-start" alt="berita 4">
          </div>
          <div class="col-md-7">
            <div class="card-body">
              <h5 class="card-title fw-bold">PROMO CASHBACK: Gunakan Mandiri Payment</h5>
              <small class="text-muted">Selasa, 25 Mei 2025</small>
              <p class="card-text mt-2">Promo berlaku untuk transaksi dengan Mandiri Payment. Jangan lewatkan kesempatan ini...</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-lg-4">
      ...
      <ul class="list-unstyled more-news-list">
        <li class="mb-3 border-bottom pb-2" data-aos="fade-left">
          <a href="#" class="berita-link">Spider-Man: No Way Home" Pecahkan Rekor Penjualan Tiket Global</a>
        </li>
        <li class="mb-3 border-bottom pb-2" data-aos="fade-left" data-aos-delay="100">
          <a href="#" class="berita-link">The Matrix Resurrections" Kembali Hadir di Dunia Sci-Fi</a>
        </li>
        <li class="mb-3 border-bottom pb-2" data-aos="fade-left" data-aos-delay="200">
          <a href="#" class="berita-link">Film Animasi "Encanto" Sukses Menjadi Favorit Keluarga</a>
        </li>
        <li class="mb-3 border-bottom pb-2" data-aos="fade-left" data-aos-delay="300">
          <a href="#" class="berita-link">Dune" Tampilkan Visual Memukau, Dapat Pujian Dunia Perfilman</a>
        </li>
        <li class="mb-3 border-bottom pb-2" data-aos="fade-left" data-aos-delay="400">
          <a href="#" class="berita-link">Film Drama "Nomadland" Menangkan Piala Oscar 2021</a>
        </li>
        <li class="mb-3 border-bottom pb-2" data-aos="fade-left" data-aos-delay="500">
          <a href="#" class="berita-link">Fast and Furious 10" Tampilkan Aksi Mendebarkan di Layar Lebar</a>
        </li>
        <li class="mb-3 border-bottom pb-2" data-aos="fade-left" data-aos-delay="600">
          <a href="#" class="berita-link">The Batman" Hadirkan Interpretasi Baru Sang Pahlawan Kota Gotham</a>
        </li>
      </ul>

      <a href="#" class="btn btn-outline-light mt-3 d-inline-flex align-items-center gap-2 transition" data-aos="fade-left" data-aos-delay="700">
    ...
    <div class="row g-4 justify-content-center">
      ...
      <div class="col-12 col-md-6 col-lg-4">
        <div class="cinematic-frame position-relative rounded-4 overflow-hidden">
          <img src="https://img.youtube.com/vi/6GmQqchjTzw/hqdefault.jpg"
               class="img-fluid w-100"
               alt="Trailer Modal Nekad"
               role="button"
        ...
        <p class="text-white mt-3 fw-semibold text-center cinematic-text">Para Pemeran Di Balik Layar : Modal Nekad</p>
      </div>

      <!-- Video Card 2 -->
      <div class="col-12 col-md-6 col-lg-4">
        <div class="cinematic-frame position-relative rounded-4 overflow-hidden">
          <img src="https://img.youtube.com/vi/BpvnEiG9bTE/hqdefault.jpg"
               class="img-fluid w-100"
      ...
      <div class="col-12 col-md-6 col-lg-4">
        <div class="cinematic-frame position-relative rounded-4 overflow-hidden">
          <img src="https://img.youtube.com/vi/-sAOWhvheK8/hqdefault.jpg"
               class="img-fluid w-100"
               alt="Marvel Trailer"
               role="button"
               data-bs-toggle="modal"
        ...
        <p class="text-white mt-3 fw-semibold text-center cinematic-text">Marvel Studios’ Thunderbolts</p>
      </div>
      ...
      <div class="col-lg-8 col-md-10">
        <div class="partner-description">
          <p class="text-light fs-4 mb-4">
            Kami bangga dapat berkolaborasi dengan berbagai perusahaan terkemuka di industri ini. Setiap langkah kami didukung oleh mitra yang memiliki visi dan misi yang sama dalam memberikan solusi terbaik untuk pelanggan kami. Bersama partner- partner ini, kami terus berkembang untuk menghadirkan layanan yang lebih inovatif dan berkualitas.
          </p>
          <p class="text-light fs-4">
            <strong>Berikut adalah partner terpercaya kami yang sangat berperan dalam perjalanan sukses kami.</strong>
          </p>
        </div>
      </div>
    </div>
...
<footer class="footer-cinetix">
  <!-- CineTix Header -->
  <h2><span class="cine" style="color: #e50914;">CINE</span><span class="tix" style="color: #f5c518;">Tix</span></h2>

  <!-- Footer Description -->
  <p class="footer-description">
    Selamat datang di CineTix, tempat di mana pengalaman menonton film terbaik tersedia bagi Anda. Dengan berbagai pilihan
    hiburan premium dan kualitas tanpa tanding, temukan keseruan yang tak terbatas.
  </p>
  ...
  <div class="footer-bottom">
    &copy; 2025 <strong>CineTix</strong>. All rights reserved.
  </div>
</footer>
